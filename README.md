...
```mermaid
%%{init: {'theme':'base','themeVariables':{'background':'transparent','primaryTextColor':'#DCE6EE','primaryColor':'#2FD9E8','primaryBorderColor':'#22343D','lineColor':'#22343D','textColor':'#DCE6EE','fontFamily':'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace'}}}%%
xychart-beta horizontal
    x-axis [Java, TypeScript, C, Rust, Python, CMake, Tcl]
    y-axis "Usage (%)" 0 --> 50
    bar [44.23, 34.60, 10.92, 6.38, 1.68, 1.54, 0.25]
```
